        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Surveys_Users_DeletedById",
                        column: x => x.DeletedById,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Surveys_Users_UpdatedById",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_SurveyQuestions_Users_CreatedById",
                        column: x => x.CreatedById,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_SurveyQuestions_Users_DeletedById",
                        column: x => x.DeletedById,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_SurveyQuestions_Users_UpdatedById",
                        column: x => x.UpdatedById,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_SurveyOptions_Users_CreatedById",
                        column: x => x.CreatedById,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_SurveyOptions_Users_DeletedById",
                        column: x => x.DeletedById,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_SurveyOptions_Users_UpdatedById",
                        column: x => x.UpdatedById,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_SurveyQuestions_SurveyOptions_SurveyQuestionId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "integer", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                    UserSubmissionId = table.Column<int>(type: "integer", nullable: false),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SurveyOptions_DeletedById",
                table: "SurveyOptions",
                column: "DeletedById");

            migrationBuilder.CreateIndex(
                name: "IX_SurveyOptions_SurveyQuestionId_Content",
                table: "SurveyOptions",
                columns: new[] { "SurveyQuestionId", "Content" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_SurveyOptions_UpdatedById",
                table: "SurveyOptions",
                column: "UpdatedById");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SurveyQuestions_DeletedById",
                table: "SurveyQuestions",
                column: "DeletedById");

            migrationBuilder.CreateIndex(
                name: "IX_SurveyQuestions_SurveyId_Content",
                table: "SurveyQuestions",
                columns: new[] { "SurveyId", "Content" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_SurveyQuestions_UpdatedById",
                table: "SurveyQuestions",
                column: "UpdatedById");
