...
public class SurveyQuestionService(ISurveyQuestionRepository questionsRepo, ISurveyRepository poolReop) : ISurveyQuestionService
{
    ...
    {
        if (!await poolReop.ExistByIdAsync(surveyId, token))
